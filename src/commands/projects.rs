...
use crate::features::types::{ApiProjectTree, CreateProjectRequest, CreateProjectResponse};

#[tauri::command]
#[specta::specta]
pub async fn list_projects(db: State<'_, DbHandle>) -> Result<Vec<ApiProjectTree>, AppError> {
